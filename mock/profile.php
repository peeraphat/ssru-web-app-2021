...
<body style="background-color: #e3e3e3;">
  <div class="container" style="background-color: #fff;">
    <div class="text-center p-4">
      <div>
        <img src="https://th.jobsdb.com/en-th/cms/employer/wp-content/plugins/all-in-one-seo-pack/images/default-user-image.png" width="250" />
      </div>
      <div class="mt-3">
        <h1>Kevin Developer</h1>
      </div>
    </div>
    ...
    <div class="mt-6" style="background-color: #fff; padding: 20px;">
        <div>
